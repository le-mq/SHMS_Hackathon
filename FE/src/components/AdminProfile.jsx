...
/**
 * AdminProfile — Profile management page for Admin / Coordinator roles.
 * Displays Identity Information (read-only) + Security & Contact (editable).
 * SHMS-FE-029
 */
const AdminProfile = () => {
