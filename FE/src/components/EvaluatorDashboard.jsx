...
const EvaluatorDashboard = () => {
                ...
                try {
                    ...
                    if (selectedContest) {
                        ...
                        dashboardMock = {...dashboardMock, queue: filteredQueue,
                            assignedCategoryCount: Array.from(new Set(filteredQueue.map(t => t.categoryName))).length,
    ...
    const dashboardData = data || {assignedCategoryCount: 0, totalAllocatedTeams: 0,
                        ...
                        {dashboardData.queue.map((team, idx) => (
                            <tr key={team.teamId || idx}>
                                ...
                                <td>
                                    ...
                                    ) : (<button className="evaluate-btn" onClick={() => navigate(`/judge/evaluate/${team.teamId}`)}>
