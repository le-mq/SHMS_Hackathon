...
const MOCK_LOGS = [
    { id: '#77281', actionType: 'DISQUALIFICATION', target: 'TEAM-2026-012', timestamp: '2026-03-14\n14:22:10', performer: 'Admin_01\n(Super)', justification: 'Confirmed rule violation' },
    { id: '#77280', actionType: 'SCORE_REVOCATION', target: 'TEAM-2026-055', timestamp: '2026-03-14\n13:58:04', performer: 'Admin_04\n(Judge)', justification: 'Late submission' },
    { id: '#77279', actionType: 'SYSTEM_CONFIG', target: 'NAV_CLUSTER_B', timestamp: '2026-03-14\n12:45:33', performer: 'System_Cron', justification: 'Automatic schedule update' },
    { id: '#77278', actionType: 'DISQUALIFICATION', target: 'TEAM-2026-092', timestamp: '2026-03-14\n11:30:12', performer: 'Admin_01\n(Super)', justification: 'Breach of conduct' },
    { id: '#77277', actionType: 'SCORE_REVOCATION', target: 'TEAM-2026-004', timestamp: '2026-03-14\n10:15:00', performer: 'Admin_02\n(Judge)', justification: 'Evaluation error corrected' },
    { id: '#77276', actionType: 'ACCESS_GRANT', target: 'USER_EXP_DEV', timestamp: '2026-03-14\n09:02:44', performer: 'Admin_01\n(Super)', justification: 'Authorized guest access' },
];
...
const EnforcementAuditLogs = () => {
        ...
        const fetchLogs = async () => {
            try {
                ...
                if (response.ok) {
                    ...
                    if (data.logs) setLogs(data.logs.map(l => ({
                        id: l.id, actionType: l.actionType, target: l.target,
                        timestamp: l.timestamp, performer: l.performer, justification: l.justification
                    })));
                }
            } catch { /* use mock data */ }
        };
    ...
    const handleExecute = async () => {
        ...
        try {
            ...
            const newLog = {
                id: data?.logId || `#${Math.floor(Math.random() * 99999)}`,
                actionType: form.actionType,
                target: form.targetEntityId,
                timestamp: new Date().toLocaleString(),
                performer: 'Admin_01\n(Super)',
                justification: form.justificationReason.substring(0, 40)
            };
            ...
            // Optimistic mock update even if backend offline
            const newLog = {
            ...
            setLogs(prev => [newLog, ...prev]);
            setForm({ targetEntityId: '', actionType: 'DISQUALIFICATION', justificationReason: '' });
            alert('Enforcement action executed and logged (Demo mode).');
        } finally {
    ...
    const handleExportCsv = () => {
        window.open('http://localhost:8080/api/v1/admin/audit-logs/export-csv', '_blank');
    };
                    ...
                    <div className="audit-stream-panel">
                        <div className="audit-stream-header">
                            ...
                            <div className="audit-actions">
                                <button className="audit-action-btn">
                                    <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="audit-table-footer">
                            <span>Showing {logs.length} of 1,248 logs</span>
                            <div style={{display: 'flex', alignItems: 'center', gap: 12}}>
                                <button className="page-btn">‹</button>
                                <span style={{fontSize: 13, color: '#475569'}}>Page 1 of 208</span>
                                <button className="page-btn">›</button>
                            </div>
                        </div>
                    </div>
