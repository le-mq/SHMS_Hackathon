...
const VerifyEmail = () => {
    ...
    const autoSendOtp = async () => {
        ...
        try {
            const response = await fetch('import.meta.env.VITE_API_BASE_URL || "import.meta.env.VITE_API_BASE_URL || "http://localhost:8080/api/v1""/auth/resend-otp', {
                method: 'POST',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('import.meta.env.VITE_API_BASE_URL || "import.meta.env.VITE_API_BASE_URL || "http://localhost:8080/api/v1""/auth/verify-email', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
