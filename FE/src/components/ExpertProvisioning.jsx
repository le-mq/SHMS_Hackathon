                                    ...
                                    <div style={{ display: 'flex', gap: '16px', marginTop: '8px' }}>
                                        <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                                            <input 
                                                ...
                                                name="roleSelection" 
                                                value="Judge" 
                                                checked={formData.roleSelection.includes('Judge')}
                                                onChange={(e) => {
                                        ...
                                        <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                                            <input 
                                                ...
                                                name="roleSelection" 
                                                value="Guest Judge" 
                                                checked={formData.roleSelection.includes('Guest Judge')}
                                                onChange={(e) => {
                                                    const value = e.target.value;
                                                    setFormData(prev => ({
                                                        ...prev,
                                        ...
                                        <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                                            <input 
                                                ...
                                                name="roleSelection" 
                                                value="Mentor" 
                                                checked={formData.roleSelection.includes('Mentor')}
                                                onChange={(e) => {
                                                    const value = e.target.value;
                                                    setFormData(prev => ({
                                                        ...prev,
                                    ...
                                    <div style={{ display: 'flex', gap: '16px', marginTop: '8px' }}>
                                        <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                                            <input 
                                                type="checkbox" 
                                                value="Judge" 
                                                checked={manageRoleSelection.includes('Judge') || manageRoleSelection.includes('JUDGE')}
                                                onChange={(e) => {
                                                    const val = 'Judge';
                                        ...
                                        <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                                            <input 
                                                type="checkbox" 
                                                value="Guest Judge" 
                                                checked={manageRoleSelection.includes('Guest Judge')}
                                                onChange={(e) => {
                                        ...
                                        <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                                            <input 
                                                type="checkbox" 
                                                value="Mentor" 
                                                checked={manageRoleSelection.includes('Mentor') || manageRoleSelection.includes('MENTOR')}
                                                onChange={(e) => {
                                                    const val = 'Mentor';
                                                    setManageRoleSelection(prev => 
                                                        e.target.checked ? [...prev, val] : prev.filter(r => r.toUpperCase() !== val.toUpperCase())
