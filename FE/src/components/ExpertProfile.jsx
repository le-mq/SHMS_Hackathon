...
const ExpertProfile = () => {
    ...
    const apiEndpoint = currentRole === 'JUDGE'
        ? 'import.meta.env.VITE_API_BASE_URL || "import.meta.env.VITE_API_BASE_URL || "http://localhost:8080/api/v1""/judge/profile'
        : 'import.meta.env.VITE_API_BASE_URL || "import.meta.env.VITE_API_BASE_URL || "http://localhost:8080/api/v1""/mentor/profile';
