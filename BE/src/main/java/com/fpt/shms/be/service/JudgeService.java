...
import com.fpt.shms.be.repository.ContestRubricRepository;
import com.fpt.shms.be.repository.ContestRubricDetailsRepository;
import com.fpt.shms.be.repository.ScoreRepository;
import com.fpt.shms.be.repository.RubricTemplateCriteriaRepository;
...
public class JudgeService {
    ...
    public EvaluationDataResponse getEvaluationData(String username, Long teamId) {
        ...
        // Verify judge has access to this team's category
        List<JudgeAssignment> assignments = judgeAssignmentRepository.findByUserId(user.getId());
        ...
        // Get rubric for this category and round
        ...
        if (rubric != null && rubric.getRubricTemplate() != null) {
            List<RubricTemplateCriteria> details = rubric.getRubricTemplate().getCriteria();
        ...
        // Fallback mock criteria if no rubric found
    ...
    public com.fpt.shms.be.dto.JudgeHistoricalLogResponse getHistoricalLog(String username) {
        ...
        for (java.util.Map.Entry<Submission, List<Score>> entry : scoresBySubmission.entrySet()) {
            ...
            String timestampStr = submission.getSubmittedAt() != null 
                    ...
                    : java.time.LocalDateTime.now().format(formatter); // Fallback if no date
            ...
            records.add(com.fpt.shms.be.dto.JudgeHistoricalLogResponse.Record.builder()
                    ...
                    .roundStatus("LOCKED") // Because it is already evaluated
